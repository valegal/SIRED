...
const DescargarMediciones = ({ setLargeSearchWarning }) => {
    ...
    return (
        <div className="py-8 px-36 mx-96 mt-5 bg-slate-200/10 border-2 border-lime-400 rounded-lg">
            ...
            <div className="mb-4 px-8 py-1 text-lg bg-lime-400/20">
                <label className="flex items-center text-sm font-medium text-gray-700">
                    <input
                        ...
                        className="mr-2"
                    />
                    Descargar todos los datos existentes
                </label>
            </div>
...
DescargarMediciones.propTypes = {
    setLargeSearchWarning: PropTypes.func.isRequired,
};

export default DescargarMediciones;
